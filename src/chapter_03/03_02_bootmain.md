...
[「2.1. ターゲットxv6.img」](https://kkmtyyz.github.io/xv6-notebook/chapter_02/02_01_xv6_img.html)で見たように、kernelは1セクタ目から存在している。    
...
プログラムヘッダは次の3エントリ。仮想アドレスと物理アドレスは[「2.4. ターゲットkernel」](https://kkmtyyz.github.io/xv6-notebook/chapter_02/02_04_kernel.html)で見たリンカスクリプトkernel.ldにより設定されている。  
